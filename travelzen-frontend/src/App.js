...
import ForgotPassword from "./UserComponent/ForgotPassword"; // Import ForgotPassword
import ResetPassword from "./UserComponent/ResetPassword"; // Import ResetPassword
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/user/forgot-password" element={<ForgotPassword />} /> {/* Add ForgotPassword route */}
